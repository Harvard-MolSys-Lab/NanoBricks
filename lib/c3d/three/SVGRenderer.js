...
module.exports = THREE.SVGRenderer = function () {
	...
	_w = 1, // z-buffer to w-buffer, changed to stop crash... change back to uninstantiated?
	_vector3 = new THREE.Vector3(), // Needed for PointLight
	_centroid = new THREE.Vector3(),

	_svgPathPool = [], _svgLinePool = [], _svgRectPool = [],
	_svgNode = null, _pathCount = 0, _lineCount = 0, _rectCount = 0,
	_quality = 1;
	...
	function renderFace3( v1, v2, v3, element, material ) {
		...
		if ( material instanceof THREE.MeshBasicMaterial ) {
			...
			if (typeof material.voxelColor === "undefined")
				_color = new THREE.Color("rgb(26,112,62)")
			else
				_color.copy( material.voxelColor );
