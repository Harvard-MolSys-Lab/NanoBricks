...
<head>
    ...
    <title>AMD setup - Demo and Playground</title>
    ...
    <link rel="stylesheet" href="browserify.css">
</head>
<body>
    ...
    <!-- body content here... -->
    <section id="header">
        <h1 class="row">Browserify setup</h1>

        <p class="row">... todo ... This page uses the AMD build in the <code>dist</code> directory, not the files in
            <code>src</code>. In other words, run the <code>grunt</code> command first to build a current version.</p>
    </section>
    <section>
        ...
        <div class="row">
            <p>Select.One collection: First item of each of the other Select.One collections<br>
                <small>Because these items are combined in a Select.One collection, you can't select the first item in more than one collections at the same time.</small>
            </p>
        </div>
        <div class="row">
    ...
    <!-- Browserified output file -->
    <script src="browserify_out.js"></script>
