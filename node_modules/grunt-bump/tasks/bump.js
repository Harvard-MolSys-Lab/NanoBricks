...
module.exports = function(grunt) {
  ...
  grunt.registerTask('bump', DESC, function(versionType, incOrCommitOnly) {
    ...
    var increment = opts.increment || grunt.config('bump.increment') || versionType || 'patch'
    ...
    runIf(opts.bumpVersion, function(){
      grunt.file.expand(opts.files).forEach(function(file, idx) {
        ...
        var content = grunt.file.read(file).replace(VERSION_REGEXP, function(match, prefix, parsedVersion, suffix) {
          ...
          version = exactVersionToSet || gitVersion || semver.inc(parsedVersion, increment);
        ...
        grunt.log.ok('Version bumped (' + increment + ') to ' + version + (opts.files.length > 1 ? ' (in ' + file + ')' : ''));
